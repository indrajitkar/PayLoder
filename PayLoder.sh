...
# Coded by @indrajit (You don't become a coder by just changing the credits)
# Github: https://github.com/indrajitkar/payloder
...
printf "\e[1;77m .Lucifar.
 ...
 #        #    #    #    ######   ####   #####   ######  #   # \e[0m\n"
printf "\n"
printf "   \e[1;92m         Author: indrajit\e[0m\n"
printf "   \e[101m::           Warning: Attacking targets without  ::\e[0m\n"
printf "   \e[101m:: You don't become a coder by just changing the credits  ::\e[0m\n"
